      ...
      <section className="rounded-3xl border border-white/10 bg-white/5 p-4 shadow-sm">
        <div className="mb-3 flex items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-1 text-lg font-semibold text-white">Why this diagnosis</h1>
          </div>
          <button
            type="button"
            onClick={onBack}
        ...
        <div className="space-y-3">
          <p className="rounded-2xl bg-white/5 p-3 text-sm leading-6 text-white/70">{summary}</p>
