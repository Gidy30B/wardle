...
const PATTERNS: PatternSuggestion[] = [
  ...
  },
  {
    ...
    metadata: {
      ...
      subspecialty: null,
      category: 'Acute abdominal inflammation',
      bodySystem: 'Gastrointestinal',
    ...
    rationale: 'Matched pancreatobiliary emergency terminology',
  },
  {
  ...
  {
    tokens: ['ectopic pregnancy', 'ruptured ectopic'],
    metadata: {
      specialty: 'Obstetrics and Gynecology',
      subspecialty: 'Emergency Gynecology',
      category: 'Gynecologic emergency',
      bodySystem: 'Reproductive',
      organSystem: 'Fallopian tube',
      difficultyBand: 'INTERMEDIATE',
      rarityBand: 'UNCOMMON',
      clinicalSetting: 'EMERGENCY',
      ageGroup: 'ADULT',
      urgencyLevel: 'EMERGENT',
      preferredClueTypes: ['history', 'vital', 'lab'],
    },
    aliases: ['Ruptured ectopic pregnancy', 'Ectopic pregnancy'],
    rationale: 'Matched gynecologic emergency terminology',
  },
  {
    tokens: ['peptic ulcer', 'pud'],
    metadata: {
      specialty: 'Gastroenterology',
      subspecialty: null,
      category: 'Upper gastrointestinal disease',
      bodySystem: 'Gastrointestinal',
      organSystem: 'Stomach and duodenum',
      difficultyBand: 'BASIC',
      rarityBand: 'COMMON',
      clinicalSetting: 'OUTPATIENT',
      ageGroup: 'ADULT',
    ...
    aliases: ['Peptic ulcer disease', 'PUD'],
    rationale: 'Matched upper gastrointestinal disease terminology',
  },
  {
    tokens: ['rickets', 'vitamin d deficiency'],
    metadata: {
    ...
    aliases: ['Vitamin D deficiency rickets', 'Nutritional rickets'],
    rationale: 'Matched pediatric metabolic bone disease terminology',
  },
  {
    tokens: ['siadh', 'syndrome of inappropriate antidiuretic'],
    metadata: {
      specialty: 'Endocrinology',
      subspecialty: null,
      category: 'Electrolyte disorder',
      bodySystem: 'Endocrine',
      organSystem: 'Pituitary and kidney',
      difficultyBand: 'ADVANCED',
      rarityBand: 'UNCOMMON',
      clinicalSetting: 'INPATIENT',
      ageGroup: 'ADULT',
      urgencyLevel: 'URGENT',
      preferredClueTypes: ['lab', 'history', 'exam'],
    },
    aliases: ['SIADH', 'Syndrome of inappropriate antidiuretic hormone secretion'],
    rationale: 'Matched hyponatremia endocrine terminology',
  },
];
