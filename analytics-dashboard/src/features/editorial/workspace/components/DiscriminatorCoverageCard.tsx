import type { DiscriminatorCoverageRowViewModel } from '../viewModels/caseReasoningViewModel.ts';

export function DiscriminatorCoverageCard({
  row,
}: {
  row: DiscriminatorCoverageRowViewModel;
}) {
  return (
